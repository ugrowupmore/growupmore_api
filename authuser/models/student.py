...
class StudentBlacklistedToken(models.Model):
    """
    ...
    class Meta:
        db_table = '"authuser"."StudentBlacklistedTokens"'

    def __str__(self):
        return f"StudentBlacklistedToken(jti={self.jti}, blacklisted_at={self.blacklisted_at})"