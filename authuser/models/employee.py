...
class EmployeeBlacklistedToken(models.Model):
    """
    ...
    class Meta:
        db_table = '"authuser"."EmployeeBlacklistedTokens"'

    def __str__(self):
        return f"EmployeeBlacklistedToken(jti={self.jti}, blacklisted_at={self.blacklisted_at})"