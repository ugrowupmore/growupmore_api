...
from .views import (
    ...
    ServiceCategoryViewSet, CourseCategoryViewSet, CourseSubCategoryViewSet, FAQCategoryViewSet,
...
router.register(r'course-sub-categories', CourseSubCategoryViewSet, basename='course-sub-category')
